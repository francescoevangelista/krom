...
window.TEXTS = [
  ...
  { title: 'Il cerchio.', body: 'Ogni volta che un kendama arriva in un posto, la gente si mette attorno a chi gioca. Una sesh è un cerchio, un jam è un cerchio organizzato, Roma a gennaio è il cerchio più grande. La fam è chi sta dentro il cerchio. Tutto il sistema serve a far vedere i cerchi che esistono e a farne nascere di nuovi.', tag: 'La parola chiave' },
